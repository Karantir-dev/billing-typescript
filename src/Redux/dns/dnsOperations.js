...
const getDNSList = (data, signal) => (dispatch, getState) => {
  dispatch(dnsActions.showLoader())
  ...
  axiosInstance
    ...
    .then(({ data }) => {
      ...
      dispatch(dnsActions.hideLoader())
    })
    .catch(error => {
    ...
    axiosInstance
      ...
      .then(({ data }) => {
        ...
        if (filtered) {
          ...
          return dispatch(getDNSList({ p_num: 1, p_cnt: data?.p_cnt }, signal))
        }
